...
namespace DonationAcademy.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        public IActionResult PedidoMateriais(int? id)
        {
            ...
            PedidoMaterialViewModel pedidoMaterial = new PedidoMaterialViewModel()
            {
                Pedido = pedido,
        ...
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,Nome,Sobrenome,Endereco1,Endereco2,Numero,Bairro,Cep,Estado,Cidade,Telefone,Email,PedidoEnviado")] Pedido pedido)
        {
